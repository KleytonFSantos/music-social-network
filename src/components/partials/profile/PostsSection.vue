      ...
      <div class="my-1 px-1 w-full md:w-1/2 lg:w-1/2">
        ...
        >
          ...
          <div class="p-2 md:p-4">
            ...
            <p class="text-gray-dark text-md">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Rerum eos corporis, nulla tempore, provident natus, nobis inventore labore numquam cum quasi excepturi id quia veniam quaerat dignissimos sequi atque rem.</p>
            <div class="mt-2 flex items-center justify-end">
              <router-link
              to="" 
              class="bg-blue-500 hover:bg-blue-700 text-white text-sm font-bold py-1 px-2 rounded-full mr-2"
              >
                Edit Post
              </router-link>
              <button
